...
class EmailService:
    ...
    def send_appointment_confirmation_email(self, user_email: str, user_name: str, doctor_name: str, appointment_time: str):
            ...
            <div class="container">
                ...
                <div class="content">
                    ...
                    <div class="status">
                        ...
                        <p style="margin: 5px 0 0 0; font-size: 14px;">You'll receive an email once the doctor reviews your request.</p>
                    </div>
                    ...
                    <ul>
                        ...
                        <li>If approved, prepare any questions or concerns for your session</li>
                    </ul>
                    
                    <p>You can check your appointment status anytime in your dashboard.</p>
                </div>
                <div class="footer">
                    <p>© 2024 AI Stress Analyzer. All rights reserved.</p>
                </div>
        ...
        <body>
            <div class="container">
                ...
                <div class="content">
                    ...
                    <p>Looking forward to supporting you on your mental health journey!</p>
                </div>
                <div class="footer">
                    <p>© 2024 AI Stress Analyzer. All rights reserved.</p>
                </div>
    ...
    def send_appointment_rejected_email(self, user_email: str, user_name: str, doctor_name: str, 
                                       appointment_time: str, rejection_reason: Optional[str] = None):
        ...
        <body>
            <div class="container">
                ...
                <div class="content">
                    <h2>Hi {user_name}, </h2>
                    <p>We wanted to let you know about your appointment request with <strong>{doctor_name}</strong> 
                    for <strong>{appointment_time}</strong>.</p>
                    ...
                    <p>Don't worry - we're here to help you find the right appointment time!</p>
                </div>
                <div class="footer">
                    <p>© 2024 AI Stress Analyzer. All rights reserved.</p>
                </div>
